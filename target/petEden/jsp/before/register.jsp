...
<head>
    ...
    <script type="text/javascript">
        ...
        function refreshCode() {
            document.getElementById("code").src =  Math.random();
        }

        //表单验证
        function checkForm() {
            var bpwd = document.bpwd.value;
            var rebpwd = document.rebpwd.value;
            if (bpwd != rebpwd) {
                alert("两次密码不一致！");
                return false;
            }
        ...
        function myReload() {
            document.getElementById("CreateCheckCode").src = document
                    ...
                    + "?nocache=" +  Math.random();
            window.location.href = "jsp/before/register.jsp";
        }
    </script>
</head>
<body>
<div class="clearfix">
    ...
    <div class="box4">
        <div class="case_ll clearfix">
            <div class="regist">
                <form action="/pet/BUserRegisterServlet" method="post" modelAttribute="buser" name="registerForm">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0"
                           class="ttbb2">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td width="59%"><input type="text" name="email" id="email"
                                                   class="my_txt_350"/></td>
                            <td width="25%"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><label class="errorClass" id="addError"></label></td>
                        </tr>
                        <tr>
                            <td align="right">&nbsp;</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="ared"><input type="text" name="code"
                                                        id="textfield5" class="my_txt_120"/> <img id="CreateCheckCode"
                                                                                                  src="/pet/PictureCheckCode"/>
                                <a href=""
                                   onclick="javascript:myReload();"> <font
                                        color="blue">看不清,换一个!</font></a>
                                <%--<a
                                        href="javascript:refreshCode();"><font
                        ...
                        <tr>
                            <td align="right">&nbsp;</td>
                            <td height="50"><input type="submit" name="button"

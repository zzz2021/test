...
<body>
						...
						<li class="dropDown dropDown_hover"><a href="javascript:;"
							...
							<ul class="dropDown-menu menu radius box-shadow">
								<li><a href="javascript:;"
									onclick="member_add('添加用户','jsp/admin/addUser.jsp','','510')"><i
										class="Hui-iconfont">&#xe60d;</i> 用户</a></li>
								<li><a href="javascript:;"
									onclick="picture_add('添加宠物','jsp/admin/addPet.jsp')"><i
										class="Hui-iconfont">&#xe613;</i> 宠物</a></li>
							</ul></li>
					</ul>
				</nav>
				<nav id="Hui-userbar"
					...
					<ul class="cl">
						...
						<li class="dropDown dropDown_hover"><a href="#"
							...
							<ul class="dropDown-menu menu radius box-shadow">
								<li><a href="jsp/admin/index.jsp">退出</a></li>
							</ul></li>
						<li id="Hui-msg"><a href="jsp/before/index.jsp" title="消息"><span
		...
		<div class="menu_dropdown bk_2">
			<dl id="menu-article">
				...
				<dd>
					<ul>
						<li><a
							data-href="jsp/admin/userList.jsp?currentPage=1"
							data-title="用户列表" href="javascript:void(0)">用户列表</a></li>
					</ul>
				</dd>
			</dl>
			<dl class="menu-picture">
				<dt>
					<i class="Hui-iconfont">&#xe613;</i> 宠物管理<i
						class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
				</dt>
				<dd>
					<ul>
						<li><a data-href="/pet/PetListServlet?currentPage=1"
							data-title="宠物管理" href="javascript:void(0)">宠物列表</a></li>
					</ul>
				</dd>
			</dl>
		</div>
	...
	<section class="Hui-article-box">
		...
		<div id="iframe_box" class="Hui-article">
			<div class="show_iframe">
				...
				<iframe scrolling="yes" frameborder="0" src="jsp/admin/welcome.jsp"></iframe>
			</div>
		</div>
	</section>
	...
	<!--请在下方写此页面业务相关的脚本-->
	<script type="text/javascript"
		src="h-ui/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
	<script type="text/javascript"

$(function() {
	...
	$(".inputClass").focus(function(){
		var labelId = $(this).attr("id")+"Error";//通过输入框找到对应的labl的id
...
function _hyz() {
	/*
	 * 1.获取<img>元素 2.重新设置它们的src 3.使用毫秒来添加参数
	 */
	document.getElementById("imgVerifyCode").src = "validateCode?" + Math.random();
}